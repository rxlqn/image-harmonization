...
%             subplot(1,2,2), imshow(I2), title('reference');
            ...
            filepath=pwd;
            cd(sprintf('E:\\coco\\composite_images\\%s_gctRGB\\groundtruth',dataType));
            imwrite(I1,sprintf('%s_%g_gctRGB_truth.jpg',dataType,imgId1));
            cd(filepath);
...
%             subplot(1,2,1),coco.showAnns(anns1);
            ...
            filepath=pwd;
            cd(sprintf('E:\\coco\\composite_images\\%s_gctRGB\\mask',dataType));
            imwrite(bm1,sprintf('%s_%g_gctRGB_mask.jpg',dataType,imgId1));
            cd(filepath);
