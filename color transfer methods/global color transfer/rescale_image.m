...
% rescale im1 using the mean and std of im2
% im1 and im2 are Nx3 matrix
%
% Wei Xu
% July 2009
% Modified Oct. 2009
...
mask1 = mask1(:,1).*mask1(:,2).*mask1(:,3);%.*region_mask1;  % Mia: comment region_mask1
valid_im1 = im1(mask1>0,:);

mask2 = ~isnan(im2) & (im2~=-Inf);
mask2 = mask2(:,1).*mask2(:,2).*mask2(:,3);%.*region_mask2;   % Mia: comment region_mask2
