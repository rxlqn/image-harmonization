...
%             imgId1 = 137281;
%             imgId2 = 75052; %from val2017 640*444 uint8, a gray imag
%             imgId1 = 205289;
%             imgId2 = 220732;
...
%             subplot(1,2,2), imshow(I2), title('reference');
            ...
            %save ground truth (original source) images
            filepath=pwd;
            cd(sprintf('E:\\coco\\composite_images\\%s_hgm\\groundtruth',dataType));
            imwrite(I1,sprintf('%s_%g_hgm_truth.jpg',dataType,imgId1));
            cd(filepath);
...
%             subplot(1,2,1),coco.showAnns(anns1);
            ...
            filepath=pwd;
            cd(sprintf('E:\\coco\\composite_images\\%s_hgm\\mask',dataType));
            imwrite(bm1,sprintf('%s_%g_hgm_mask.jpg',dataType,imgId1));
            cd(filepath);
